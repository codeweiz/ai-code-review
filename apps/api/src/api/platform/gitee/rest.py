...
from api.platform.gitee.models import (CommitItem, FileContent, PullRequest,
                                       PullRequestFile, Webhook)
from common.config import appConfig
from pydantic import BaseModel


@register_platform(PLATFORM_GITEE)
class GiteeGitPlatform(GitPlatform):
    """Gitee 实现的代码仓库平台"""

    def __init__(self):
        self.base_url = appConfig.gitee.base_url
        self.token = appConfig.gitee.token
